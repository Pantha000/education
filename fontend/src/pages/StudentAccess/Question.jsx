  ...
  return (
    <div className="px-12 pt-20">
      ...
      <div className="mt-6 flex items-start  ">
        <div className="w-2/12 bg-slate-500 p-4 mt-2 rounded-md">
          <h4 className="text-white font-semibold text-xl">Semester</h4>
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        <a className="block w-fit text-white bg-gray-500 mt-2 px-2 py-1 rounded-md text-xs">
                          Download Question
                        </a>
                      </div>
                    </div>
